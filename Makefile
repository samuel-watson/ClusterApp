...
SOURCES += ./src/clusterapp.cpp ./src/design.cpp ./src/glmmmodel.cpp ./src/modelchecker.cpp
SOURCES += ./src/modelupdater.cpp ./src/multiColorButton.cpp ./src/sequenceperiod.cpp ./src/statisticalmodel.cpp
...
$(OUTPUT): $(SOURCES) 
	$(CXX)  $(SOURCES) -std=c++17 -o $(OUTPUT) $(LIBS) $(WEBGL_VER) -O2 --preload-file data $(USE_WASM) -I$(IMGUI_DIR) -I$(IMGUI_DIR)/backends -I$(EIGEN_DIR) -I$(BOOST_DIR)
